...
function main() {
                ...
                case 'normal':
                    switch (d.name) {
                        ...
                        case "BIG2":
                            ...
                            setGamemode('big');
                            sounder.playSound("big" + (["BIG1","BIG2"].indexOf(d.name) + 1), true)
                            bonusdata = {
                                bonusget: 345,
                                geted: 0
                            }
    ...
    var segments = {
        ...
        effectseg: segInit("#effectSegment", 3,true)
    }
    ...
    segments.effectseg.setOffColor(10,10,10)
...
function segInit(selector, size,bool) {
    var cangvas = $(selector)[0];
    var sc = new SegmentControler(cangvas, size,bool?5:0, bool?29:-3, bool?200:79, bool?250:46,bool);
